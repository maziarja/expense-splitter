  ...
  return (
    <input
      ...
      className={cn(
        ...
        // page on focus for any text input rendered under 16px, and md:text-xs
        // is unaffected since that breakpoint only applies to non-touch/desktop
        // viewports where Safari doesn't have this behavior.
