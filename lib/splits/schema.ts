...
export const expenseBaseSchema = z.object({
  ...
  rateIsUserSet: z.boolean().optional(),
...
type ExpenseSplitFields = Pick<
  z.infer<typeof expenseBaseSchema>,
  "splitType" | "splits" | "amount" | "currency"
>;

export function refineExpenseSplits(
  expense: ExpenseSplitFields,
  ctx: z.RefinementCtx,
) {
...
export const expenseSchema = expenseBaseSchema.superRefine(refineExpenseSplits);
